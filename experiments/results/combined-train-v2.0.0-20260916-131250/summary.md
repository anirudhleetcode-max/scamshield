...
Full system (logreg_cal + rules): flag≥Suspicious P=0.968 R=0.943 F1=0.956; flag=Scam P=0.996 R=0.888 F1=0.939; verdicts {'Safe': 727, 'Suspicious': 104, 'Scam': 1116}; abstention {'abstained': 324, 'coverage': 0.8336, 'model_accuracy_on_covered': 0.9834}
...
Full system (logreg_cal + rules): flag≥Suspicious P=1.000 R=0.948 F1=0.973; flag=Scam P=1.000 R=0.917 F1=0.957; verdicts {'Safe': 683, 'Suspicious': 3, 'Scam': 88}; abstention {'abstained': 6, 'coverage': 0.9922, 'model_accuracy_on_covered': 0.9974}
