...
- **Live demo:** https://scamshield-anirudh-ed2c.vercel.app
- **API:** https://scamshield-api-qtja.onrender.com/api/health
- **Repository:** https://github.com/anirudhleetcode-max/scamshield
...
Checked live: sign-up, a KYC-scam message scored **96/100 "Scam"** (calibrated probability 0.998,
pattern *OTP harvesting*), a bank OTP notice scored **17 "Safe"**, and a two-character fragment
returned **"Insufficient confidence"** with reason `too_short`. Saved checks persist to Atlas and
reload from history.
